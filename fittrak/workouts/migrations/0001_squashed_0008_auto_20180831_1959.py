...
class Migration(migrations.Migration):
    ...
    replaces = [('workouts', '0001_initial'), ('workouts', '0002_auto_20180509_0000'), ('workouts', '0003_auto_20180711_1636'), ('workouts', '0004_auto_20180711_1639'), ('workouts', '0003_auto_20180711_2121'), ('workouts', '0005_merge_20180711_2123'), ('workouts', '0006_auto_20180714_2008'), ('workouts', '0007_auto_20180819_1649'), ('workouts', '0008_auto_20180831_1959')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(choices=[('KG', 'Kilograms'), ('LB', 'Pounds')], default='LB', max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'Pending'), ('IN_PROGRESS', 'In Progress'), ('CANCELLED', 'Cancelled'), ('COMPLETE', 'Complete')], default='PENDING', max_length=32)),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('-id',),
